...
import com.jolky.magicasakurax.R;
...
public class TintProgressDialog extends AlertDialog implements Handler.Callback {
    ...
    protected TintProgressDialog(Context context, boolean cancelable, DialogInterface.OnCancelListener cancelListener) {
    ...
    public static com.jolky.magicasakurax.widgets.TintProgressDialog show(Context context, CharSequence title,
    ...
    public static com.jolky.magicasakurax.widgets.TintProgressDialog show(Context context, CharSequence title,
        ...
        com.jolky.magicasakurax.widgets.TintProgressDialog dialog = new com.jolky.magicasakurax.widgets.TintProgressDialog(context);
