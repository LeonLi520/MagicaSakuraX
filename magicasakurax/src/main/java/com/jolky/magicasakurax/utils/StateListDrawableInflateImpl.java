...
package com.jolky.magicasakurax.utils;
...
import com.jolky.magicasakurax.drawables.FilterableStateListDrawable;
    ...
    public Drawable inflateDrawable(Context context, XmlPullParser parser, AttributeSet attrs) throws IOException, XmlPullParserException {
        ...
        while ((type = parser.next()) != XmlPullParser.END_DOCUMENT
            ...
            if (dr == null) {
                ...
                ColorFilter colorFilter = DrawableUtils.getAttrColorFilter(context, attrs, R.attr.drawableTint, R.attr.drawableTintModel);
                if (colorFilter != null) {
